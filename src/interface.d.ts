...
export interface LanguageLearningAPI {
  ...
  updateExerciseStats: (key: string, isCorrect: boolean, snapshot?: { userAnswer: string; correctAnswer: string; nativeText: string }) => Promise<{ success: boolean; error?: string }>;
